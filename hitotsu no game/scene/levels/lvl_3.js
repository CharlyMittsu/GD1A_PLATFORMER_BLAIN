class lvl3 extends Phaser.Scene{
    ...
    create(){
        ...
        const carteDuNiveau = this.make.tilemap({key:"niveau3"});
        ...
        carteDuNiveau.getObjectLayer('win').objects.forEach((rect)=>{
            this.bouton = this.bluffBouton.create(rect.x+rect.width/2,rect.y+rect.height/2,"bluffBouton").setOrigin(0).setScale(0.5);
        ...
        var consigne=this.add.text(this.cameraX, this.cameraY+653,"Appuie sur le bouton !",{ fontSize: '72px', fontFamily: 'MS UI Gothic' }).setOrigin(0.5);
