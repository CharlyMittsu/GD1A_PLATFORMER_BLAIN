class lvl5 extends Phaser.Scene{
    ...
    create(){
        ...
        this.bluffBouton = this.physics.add.group({
            allowGravity : false,
            immovable : true,
        })
        //score de bouton des joueurs
        this.bluffPoint1 = 0;
        this.bluffPoint2 = 0;
        ...
        //____________________________
        let randomiser= 'niveau5.'+`${(Phaser.Math.Between(1,2))}`
        console.log(randomiser)
        const carteDuNiveau = this.make.tilemap({key: randomiser});
        ...
        carteDuNiveau.getObjectLayer('win').objects.forEach((rect)=>{
            this.bouton = this.bluffBouton.create(rect.x+rect.width/2,rect.y-rect.height/2,"bluffBouton").setOrigin(0.5).setScale(0.4);
            this.bouton.pushed=false;
        });
        ...
        var consigne=this.add.text(this.cameraX, this.cameraY+653,"Appuie sur le plus de boutons possible !",{ fontSize: '72px', fontFamily: 'MS UI Gothic' }).setOrigin(0.5);
        ...
        this.physics.add.overlap(this.joueur1,this.bluffBouton,this.pushBouton1,null,this);
        this.physics.add.overlap(this.joueur2,this.bluffBouton,this.pushBouton2,null,this);
    ...
    update(time,delta){
        ...
        //check des bluff point____________
        //_________________________________

        console.log(this.bluffBouton.countActive(true))
    ...
    pushBouton1 (player,bouton){
        if(bouton.pushed==false){
            bouton.setFrame(1);
            bouton.pushed = true
            this.bluffPoint1 +=1
            console.log(this.bluffPoint1)
            setTimeout(function(){
                bouton.disableBody(true,true);
                if (this.bluffBouton.countActive(true)==0){
                    if (this.bluffPoint1>this.bluffPoint2){this.nextLvl1(),console.log("bleu gagne")}
                    else {this.nextLvl2(),console.log("rouge gagne")}
                }
            }.bind(this), 500);
        }
        //
    ...
    pushBouton2 (player,bouton){
        if(bouton.pushed==false){
            bouton.setFrame(1);
            bouton.pushed = true
            this.bluffPoint2 +=1
            console.log(this.bluffPoint2)
            setTimeout(function(){
                bouton.disableBody(true,true);
                if (this.bluffBouton.countActive(true)==0){
